...
public class ListarMisReservacionesFragment extends Fragment {

    private ListarMisReservacionesViewModel mViewModel;

    ListView objLista;

    RadioButton objRecientes;
    RadioButton objDiasInicio;
    RadioButton objDiasFinal;
    ...
    public static ListarMisReservacionesFragment newInstance() {
        return new ListarMisReservacionesFragment();
    }

    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View root = inflater.inflate(R.layout.fragment_listar_mis_reservaciones, container, false);
    ...
    private void asignar(View root) {
        ...
        objLista = root.findViewById(R.id.idListarMisReservacionesListViewListar);

        objRecientes = root.findViewById(R.id.idListarMisReservacionesRadioButtonRecientes);
        objDiasInicio = root.findViewById(R.id.idListarMisReservacionesRadioButtonDiasInicio);
        objDiasFinal = root.findViewById(R.id.idListarMisReservacionesRadioButtonDiasFinal);
    ...
    private void listar() {
        ...
        objDiasFinal.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                aux_filtro="c_res_ae_ref_id_usuario_actual";
                aux_listar();
            }
        });
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = new ViewModelProvider(this).get(ListarMisReservacionesViewModel.class);
