package com.example.paasdcmfirebasehotel.ui.listarmisreservacionesusuario;
...
public class ListarMisReservacionesUsuarioFragment extends Fragment {

    private ListarMisReservacionesUsuarioViewModel mViewModel;

    ListView objLista;

    RadioButton objRecientes;
    RadioButton objDiasInicio;
    ...
    public static ListarMisReservacionesUsuarioFragment newInstance() {
        return new ListarMisReservacionesUsuarioFragment();
    }

    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,  @Nullable Bundle savedInstanceState) {
        View root = inflater.inflate(R.layout.fragment_listar_mis_reservaciones_usuario, container, false);
    ...
    private void asignar(View root) {
        ...
        objLista = root.findViewById(R.id.idListarMisReservacionesUsuarioListViewListar);

        objRecientes = root.findViewById(R.id.idListarMisReservacionesUsuarioRadioButtonRecientes);
        objDiasInicio = root.findViewById(R.id.idListarMisReservacionesUsuarioRadioButtonDiasInicio);
    ...
    private void listar() {
        ...
        objRecientes.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                aux_filtro="c_res_aj_fecha_creacion";
                aux_listar();
            }
        });

        objDiasInicio.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                aux_filtro="c_res_af_fecha_inicio";
                aux_listar();
            }
        });
        ...
        databaseReferenceReservacion.child( "Reservaciones1" ).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (int i=0; i < referenciasIDsReservaciones.size(); i++){
                    ...
                    databaseReferenceReservacion.child( "Reservaciones1" ).child( referenciasIDsReservaciones.get( aux_pos_res_id ).toString() ).orderByChild( aux_filtro ).addValueEventListener(new ValueEventListener() {
                        @Override
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                            ...
                            String aux_id = dataSnapshot.child( "c_res_ae_ref_id_usuario_actual" ).getValue().toString();
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = new ViewModelProvider(this).get(ListarMisReservacionesUsuarioViewModel.class);
